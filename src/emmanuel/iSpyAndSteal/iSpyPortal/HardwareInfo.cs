...
namespace iSpyPortal
{
    public static class HardwareInfo
    {
        ...
        /// <summary>
        /// Retrieving Computer System Boot Time.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Retrieving Computer System Up Time.
        /// </summary>
        /// <returns></returns>
        public static DateTime GetSystemUpTime()
        {
            ...
            {
                time = ManagementDateTimeConverter.ToDateTime(mo.Properties["LastBootUpTime"].Value.ToString());
            }
            return time;
        }
    }
